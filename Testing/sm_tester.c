...
/// us init returned ok and steering returned ok
...
if(state_error==E_NOK)
    ...
    // if us_get_distance returns nok
...
if(state_error==E_NOK)
    ...
    // if steer steering car returns nok
...
a_u8_error_state_Steering_SteerCar = E_OK ;
      ...
      state_error|= Car_SM_Update();
        ...
        // id distance is  between 20 and 40
